...
unsafe impl<'o, SS:YesNo, By: RefOrVal, A: ActNext<'o, SS, By>> Ssmark<SS> for SSActNextWrap<SS, By, A> {}
...
unsafe impl<'o, SS:YesNo, By: RefOrVal, A: ActEc<'o, SS, By>> Ssmark<SS> for SSActEcWrap<By, A> {}


pub struct SsForward<SS:YesNo, Caps: Ssmark<SS>> { captures: Caps, PhantomData: PhantomData<SS> }
...
unsafe impl<SS:YesNo, Caps: Ssmark<SS>> Ssmark<SS> for SsForward<SS, Caps> {}

impl<SS:YesNo, Caps: Ssmark<SS>> Deref for SsForward<SS, Caps>
{
    type Target = Caps;
