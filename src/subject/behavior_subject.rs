...
impl<'o, V, E:Clone, SS:YesNo> BehaviorSubject<'o, SS, V, E>
{
    ...
    #[inline(never)]
    fn sub_internal(&self, next: Arc<FnNext<NO, Ref<V>>+'o>, make_sub: impl FnOnce()->Unsub<'o, SS>) -> Unsub<'o, SS>
    {
        self.lock.enter();
...
{
    fn sub(&self, next: impl FnNext<NO, Ref<V>>+'o, ec: impl FnErrComp<NO, Ref<E>>+'o) -> Unsub<'o, NO> where Self: Sized
    {
