...
unsafe impl<'a, V, R, F: Fn(V)->R+Send+Sync+'a>
Act<YES, Val<V>, R>
for F
{
    #[inline(always)] fn call(&self, v: V) -> R { self(v) }
...
unsafe impl <'a, SS:YesNo, BY: RefOrVal, R>
Act<SS, BY, R>
for Box<Act<SS, BY, R>+'a>
{
...
unsafe impl<'a, V, R, F: FnOnce(V) -> R+'a>
ActOnce<NO, Val<V>, R>
for F
{
...
unsafe impl<'a, V, R, F: FnOnce(V)->R+Send+Sync+'a>
ActOnce<YES, Val<V>, R>
for F
{
    #[inline(always)] fn call_once(self, v: V) -> R { self(v) }
...
unsafe impl<'a, R, F: FnOnce()->R+Send+Sync+'a>
ActOnce<YES, (), R>
for F
{
...
unsafe impl<'a, SS:YesNo, A: RefOrVal, R, F: ActOnce<SS, A, R>>
ActBox<SS, A, R>
for F
{
...
unsafe impl <'a, SS:YesNo, BY: RefOrVal, R>
ActOnce<SS, BY, R>
for Box<ActBox<SS, BY, R>+'a>
{
    #[inline(always)] fn call_once(self, v: BY::V) -> R { self.call_box(v) }
}


unsafe impl<SS:YesNo, By: RefOrVal, R, A: Act<SS, By, R>>
Act<SS, By, R>
for Arc<A>
{
    #[inline(always)]
...
unsafe impl<SS:YesNo, A: RefOrVal>
Act<SS, A>
for ()
{
